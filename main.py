...
if Num in ["00", "01", "02"]:
    cam0_2 = PinholeCamera(640, 480, 718.8560, 718.8560, 607.1928, 185.2157)
elif Num in ["03"]:
...
# pose_path
pose_path = '/home/roboclub/Documents/VO_tings/dataset/poses/' + Num + '.txt'
...
for img_id in range(4541):
    ...
    print("height" + str(sp_vo.cam.height) + " " + str(img.shape))
    ...
    # draw trajectory
    cv2.circle(traj, (int(1.5*sp_draw_x), int(1.5*sp_draw_y)), 1, (0, 255, 0), 1)
    ...
    cv2.imshow('Camera View', np.concatenate((sp_img, img), axis=0))
